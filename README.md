<div align="center">
  ...
  **Personal Website: [tanjunkai2001.github.io](https://tanjunkai2001.github.io/)**
  ...
  [![ResearchGate](https://img.shields.io/badge/ResearchGate-00CCBB?style=for-the-badge&logo=researchgate&logoColor=white)](https://www.researchgate.net/profile/Junkai-Tan-2)
  [![ORCID](https://img.shields.io/badge/ORCID-A6CE39?style=for-the-badge&logo=orcid&logoColor=white)](https://orcid.org/0009-0002-0558-6357)
  [![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:tanjk@stu.xjtu.edu.cn)
...
- **[2025.12]** 🏆 Received "Outstanding Report Award" at DUT Robotics & Intelligent Systems Academic Forum.
- **[2025.11]** 🏅 Awarded **National Scholarship** & "Guodian Nanzi Special Scholarship".
- **[2025.11]** 📝 Papers accepted by **EAAI**, **IEEE T-SMC**, and **IEEE T-AES**.
- **[2025.10]** 🎖️ Honored as "Student Pacesetter" at XJTU (Top 15/30,000+).
- **[2025.07]** 📝 Papers accepted by **IEEE/CAA JAS** (IF: 19.2) and **IEEE T-IE**. -->

## 🔬 Research Interests

My research focuses on enabling autonomous systems to learn and adapt safely in complex real-world environments through human–AI collaboration.
...
1. **Fixed-time stochastic learning from human-UAV interaction with state-input constraints**  
   ...
   *IEEE Transactions on Industrial Electronics (**IEEE T-IE**)*, 2025.

2. **Fixed-time hierarchical game-based unmanned aerial-ground vehicle docking control**  
   **Junkai Tan**, S. Xue, Z. Guo, H. Cao, B. Chen  
   *IEEE/CAA Journal of Automatica Sinica (**IEEE/CAA JAS**)*, 2025 *Accepted*.

3. **Prescribed performance robust approximate optimal tracking control via Stackelberg game**  
   **Junkai Tan**, S. Xue, H. Li, Z. Guo, H. Cao, D. Li  
   *IEEE Transactions on Automation Science and Engineering (**IEEE T-ASE**)*, 2025. [[Link](https://ieeexplore.ieee.org/document/10916718)]

4. **Hierarchical Safe Reinforcement Learning Control for Leader-Follower Systems with Prescribed Performance**  
   **Junkai Tan**, S. Xue, et al.  
   *IEEE Transactions on Automation Science and Engineering (**IEEE T-ASE**)*, 2025. [[Link](https://ieeexplore.ieee.org/document/11121383)]
